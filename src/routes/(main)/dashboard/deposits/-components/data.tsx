export type DepositStatus = "Active" | "Pending invite" | "Deactivated" | "Locked" | "Suspended";
...
export type DepositTeam = (typeof teamValues)[number];
...
export const statusMeta: Record<DepositStatus, { badgeClass: string; dotClass: string }> = {
  Active: {
