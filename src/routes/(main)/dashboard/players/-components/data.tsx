export type PlayerStatus = "Active" | "Pending invite" | "Deactivated" | "Locked" | "Suspended";
...
export type PlayerTeam = (typeof teamValues)[number];
...
export const statusMeta: Record<PlayerStatus, { badgeClass: string; dotClass: string }> = {
  Active: {
