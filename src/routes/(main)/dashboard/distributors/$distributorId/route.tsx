...
export const Route = createFileRoute("/(main)/dashboard/distributors/$distributorId")({
  component: Page,
});
...
function Page() {
  ...
  if (!distributor) {
    return (
      <section data-content-padding="false" className="min-h-full bg-background p-6">
        <div className="rounded-xl border p-8">
          <h1 className="text-xl font-semibold">Distributor not found</h1>
          <p className="mt-2 text-sm text-muted-foreground">The requested distributor account does not exist.</p>
          <Button asChild variant="outline" className="mt-5">
            <Link to="/dashboard/distributors">
              <ArrowLeft />
